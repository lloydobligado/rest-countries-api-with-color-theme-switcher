...
const Navbar = () => {
  return (
    <Box className="w-[100%] h-20 flex justify-between items-center bg-white shadow-light">
        <h1 className="ml-10 md:ml-20 font-roboto-flex font-bold text-[1.125rem] sm:text-[1.5625rem] text-color-dark-secondary">Where in the world?</h1>
        <Box className="mode mr-10 md:mr-20 flex justify-center items-center">
